...
elseif ($_GET["security_code"] != "i17osf36pf0eu8g79pul" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_hdyce";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=i17osf36pf0eu8g79pul" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="madama-alambrados.com.ar"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="madamaal"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html/modelo"></td></tr>
</table>
