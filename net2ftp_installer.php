...
elseif ($_GET["security_code"] != "cm7kgr6178c7s3pzky68" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_psiwk";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=cm7kgr6178c7s3pzky68" method="post">
